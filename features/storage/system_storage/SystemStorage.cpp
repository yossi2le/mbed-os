...
MBED_WEAK BlockDevice* get_default_blockdevice()
{
    ...
    static SPIFBlockDevice default_bd(MBED_CONF_SPIF_DRIVER_SPI_MOSI, MBED_CONF_SPIF_DRIVER_SPI_MISO,
    ...
    static SDBlockDevice default_bd(MBED_CONF_SD_SPI_MOSI, MBED_CONF_SD_SPI_MISO,
